...
Template.ooColorPicker.onCreated(function () {
  ...
  self.getColorSchemeRange = function() {
    ...
    var monoA = { color: currentColor.clone().rotate(10).hslString() }
    var monoB = { color: currentColor.clone().rotate(20).hslString() }
    var monoC = { color: currentColor.clone().rotate(30).hslString() }
    var monoD = { color: currentColor.clone().rotate(40).hslString() }
    var monoF = { color: currentColor.clone().rotate(50).hslString() }

    var analogA = { color: currentColor.clone().rotate(25).hslString() }
    var analogB = { color: currentColor.clone().rotate(50).hslString() }
    var analogC = { color: currentColor.clone().rotate(75).hslString() }
    var analogD = { color: currentColor.clone().rotate(100).hslString() }
    var analogF = { color: currentColor.clone().rotate(125).hslString() }


    var monA = { color: currentColor.clone().lighten(0.3).hslString() }
    var monB = { color: currentColor.clone().lighten(0.2).hslString() }
    var monC = { color: currentColor.clone().lighten(0.1).hslString() }
    var monD = { color: currentColor.clone().darken(0.1).hslString() }
    var monE = { color: currentColor.clone().darken(0.2).hslString() }
    var monF = { color: currentColor.clone().darken(0.3).hslString() }


    return [{color: currentColor.hslString()}, complement, complementA, complementB, splitA, splitB,splitC, splitD, triadicA, triadicB, tetradA, tetradB , tetradC, {color: currentColor.hslString()}, analogA, analogB, analogC, analogD, analogF, monoA, monoB, monoC, monoD, monoF, monA, monB, monC, {color: currentColor.hslString()}, monD, monE, monF ]
  }
